...
<div class="row">
  <div class="col-md-4 col-sm-6 col-xs-12">
	  <?php
        ...
        $condiciones_ingreso = array('Asistir al Curso' => 'Asistir al Curso', 'Aprobar Curso' => 'Aprobar Curso', 'Examen de Ingreso' => 'Examen de Ingreso', 'Prueba de nivel o aptitud' => 'Prueba de nivel o aptitud', 'Sin requisitos- unicamente Primario' => 'Sin  requisitos - unicamente Primario', 'Sin requisitos- unicamente Secundario' => 'Sin  requisitos - unicamente Secundario', 'Otros' => 'Otros');
        ...
        echo $this->Form->input('ciclo_implementacion', array('label' => 'Ciclo de implementación*', 'between' => '<br>', 'class' => 'form-control', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Introduzca el año inicial de vigencia del título', 'placeholder' => 'Ejemplo: 2017'));
        echo $this->Form->input('ciclo_finalizacion', array('label' => 'Ciclo de finalización', 'between' => '<br>', 'class' => 'form-control', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Introduzca el año final de vigencia del título', 'placeholder' => 'Ejemplo: 2017'));
        if (($current_user['role'] == 'superadmin') || ($current_user['puesto'] == 'Dirección Instituto Superior')) {
          ...
          echo $this->Form->input('tipo_formacion', array('label' => 'Formación tipo', 'empty' => 'Ingrese un tipo...', 'options' => $tipo_formaciones, 'between' => '<br>', 'class' => 'form-control'));
          ...
          echo $this->Form->input('tipo', array('label' => 'Tipo', 'empty' => 'Ingrese un tipo...', 'options' => $tipos, 'between' => '<br>', 'class' => 'form-control'));
		    }
  ...
  <div class="col-md-4 col-sm-6 col-xs-12">
	  <?php
          ...
          echo $this->Form->input('Titulacion.Centro', array('label' => 'Centro*', 'multiple' => true, 'default'=>$titulacionesCentros, 'between' => '<br>', 'class' => 'form-control', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Seleccione una opción de la lista'));
      ?>
  </div>
  </div>
