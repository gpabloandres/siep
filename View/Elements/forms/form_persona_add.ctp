...
<div class="row">
	<div class="col-md-4 col-sm-6 col-xs-12">
			...
			<?php	
				if ($current_user['role'] == 'superadmin') {
					...
					echo $this->Form->input('alumno', array('between' => '<br>', 'class' => 'form-control', 'label' => "Alumno", 'type' => 'checkbox', 'checked'=>true, 'before' => '<label class="checkbox">'));
		...
		<div class="unit"><strong><h3>PASO 2: Datos Generales</h3></strong><hr />
			<?php		
				...
				*/
				...
				echo $this->Form->input('documento_nro', array('label'=>'Número de Documento (*Obligatorio)', 'between' => '<br>', 'class' => 'form-control', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Indique el número sin puntos, ni guiones, ni espacios', 'placeholder' => 'Ingrese un nº de documento...'));
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
    	<div class="unit"><strong><h3>PASO 3: Datos de Nacimiento</h3></strong><hr />
			<?php
				echo $this->Form->input('fecha_nacimiento', array('id'=>'fecha_nacimiento','label' => 'Fecha de nacimiento (*Obligatorio)', 'between' => '<br>', 'class' => 'form-control', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Ingrese la fecha de nacimiento...'));
				echo $this->Form->input('pcia_nac', array('label' => 'Lugar de Nacimiento (*Obligatorio)', 'between' => '<br>', 'class' => 'form-control', 'Placeholder' => 'Ingrese un lugar de nacimiento...'));
