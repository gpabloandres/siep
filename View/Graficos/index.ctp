  ...
  <div class="row">
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">
          <div class="text-left">
            <span class="link"><?php echo $this->Html->link('<i class= "glyphicon glyphicon-home"></i> <strong> PASES - ENTRANTES</strong>', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'btn btn-primary', 'target' => '_blank', 'escape' => false)); ?><span class="badge"> | <?php echo $matriculaPasesEntrantes?></span></span>
          </div>
        </div>  
          <div class="panel-body">
            <!-- INICIO: Recuento para secciones de INICIAL.-->
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th><span class="link"><?php echo $this->Html->link('3s', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:Sala de 3 años/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <th><span class="link"><?php echo $this->Html->link('4s', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:Sala de 4 años/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <th><span class="link"><?php echo $this->Html->link('5s', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:Sala de 5 años/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                  </tr>
                </thead>
                <tbody>
            ...
            <!-- INICIO: Recuento para secciones de PRIMARIO Y SECUNDARIO.-->
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th><span class="link"><?php echo $this->Html->link('1ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:1ro/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <th><span class="link"><?php echo $this->Html->link('2ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:2do/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <th><span class="link"><?php echo $this->Html->link('3ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:3ro/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                  <?php if ($nivelCentro == 'Común - Primario' || $nivelCentro == 'Común - Secundario'): ?>  
                    <th><span class="link"><?php echo $this->Html->link('4ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:4to/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <th><span class="link"><?php echo $this->Html->link('5ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:5to/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <th><span class="link"><?php echo $this->Html->link('6ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:6to/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                  <?php endif; ?>
                  <?php if ($nivelCentro == 'Común - Secundario'): ?>
                    <th><span class="link"><?php echo $this->Html->link('7ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:7mo/division:/estado_inscripcion:CONFIRMADA/tipo_inscripcion:Pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                  <?php endif; ?>
                  <?php if ($nivelCentro == 'Adultos - Primario'): ?>
                    <th><span class="link"><?php echo $this->Html->link('Alfabetización', array('controller' => 'cursos', 'action' => 'index/turno:/anio:ALFABETIZACIÓN /division:/tipo:Múltiple'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <th><span class="link"><?php echo $this->Html->link('CAP', array('controller' => 'cursos', 'action' => 'index/turno:/anio:CAP /division:/'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
      ...
      <div class="col-sm-4"> 
        <div class="panel panel-primary">
          <div class="panel-heading">
            <div class="text-left">
              <span class="link"><?php echo $this->Html->link('<i class= "glyphicon glyphicon-home"></i> <strong> PASES - SALIENTES</strong>', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'btn btn-primary', 'target' => '_blank', 'escape' => false)); ?><span class="badge"> | <?php echo $matriculaPasesSalientes?></span></span>
            </div>
          </div>  
            <div class="panel-body">
              <!-- INICIO: Recuento para secciones de INICIAL.-->
              <?php if($nivelCentro == 'Común - Inicial'): ?>
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th><span class="link"><?php echo $this->Html->link('3s', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:Sala de 3 años/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                      <th><span class="link"><?php echo $this->Html->link('4s', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:Sala de 4 años/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                      <th><span class="link"><?php echo $this->Html->link('5s', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:Sala de 5 años/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <?php if($nivelCentro == 'Común - Primario' || $nivelCentro == 'Común - Secundario' || $nivelCentro == 'Adultos - Primario' || $nivelCentro == 'Adultos - Secundario'): ?>
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th><span class="link"><?php echo $this->Html->link('1ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:1ro/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                      <th><span class="link"><?php echo $this->Html->link('2ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:2do/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                      <th><span class="link"><?php echo $this->Html->link('3ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:3ro/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <?php if ($nivelCentro == 'Común - Primario' || $nivelCentro == 'Común - Secundario'): ?>  
                      <th><span class="link"><?php echo $this->Html->link('4ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:4to/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                      <th><span class="link"><?php echo $this->Html->link('5ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:5to/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                      <th><span class="link"><?php echo $this->Html->link('6ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:6to/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <?php endif; ?>
                    <?php if ($nivelCentro == 'Común - Secundario'): ?>
                      <th><span class="link"><?php echo $this->Html->link('7ºs', array('controller' => 'cursos_inscripcions', 'action' => 'index/ciclo_id:6/turno:/anio:7mo/division:/estado_inscripcion:BAJA/tipo_baja:Salido con pase'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                    <?php endif; ?>
                    <?php if ($nivelCentro == 'Adultos - Primario'): ?>
                      <th><span class="link"><?php echo $this->Html->link('Alfabetización', array('controller' => 'cursos', 'action' => 'index/turno:/anio:ALFABETIZACIÓN /division:/tipo:Múltiple'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
                      <th><span class="link"><?php echo $this->Html->link('CAP', array('controller' => 'cursos', 'action' => 'index/turno:/anio:CAP /division:/'), array('class' => 'link', 'target' => '_blank', 'escape' => false)); ?></th>
