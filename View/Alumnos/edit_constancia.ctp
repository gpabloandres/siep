	        ...
	        <div class="unit">
                ...
                <!--<h3>Datos del Alumno</h3>-->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="unit">
                            <p class="text-center"><?php echo($inscripcion['centro']['sigla'] ." C.U.E. N° ".$inscripcion['centro']['cue']); ?></p>
                            <p style="padding:10px; font-size:12px;font-weight: bold;" class="text-center">
                            ...
                            <div class="alumnos form">
                                ...
                                echo $this->Form->input('observaciones',array('label'=>'Observaciones', 'type' => 'textarea', 'between' => '<br>', 'class' => 'form-control'));
